...
### Backward-incompatible API changes
 ...
 -  `BlockChain<T>()` no longer accepts an `Libplanet.Store.Store` where
    `Libplanet.Store.Store.GetCanonicalChainId()` is `null`.  For on-the-fly `BlockChain<T>`
 ...
 -  `BlockChain<T>()` now throws an `ArgumentException` if provided `Libplanet.Store.Store`
    does not have its canonical chain id set or provided chain id is not found.
    [[#1486], [#2585], [#2889]]
 -  Added `Libplanet.Store.Store.GetChainBlockCommit()` and `Libplanet.Store.Store.PutChainBlockCommit()`
    interface methods.  [[#2878], [#2894]]

### Added APIs

 -  Added `BlockChain<T>.Create()` factory method for creating a `BlockChain<T>`
    with an empty `Libplanet.Store.Store`.  [[#2863]]
...
### Backward-incompatible API changes
 ...
 -  Added `Libplanet.Store.Store.GetBlockCommit(BlockHash)` method.  [[#2872]]
 -  Added `Libplanet.Store.Store.PutBlockCommit(BlockCommit)` method.  [[#2872]]
 -  Added `Libplanet.Store.Store.DeleteBlockCommit(BlockHash)` method.  [[#2872]]
 -  Added `Libplanet.Store.Store.GetBlockCommitHashes()` method.  [[#2872]]
...
### Backward-incompatible API changes
 ...
 -  Removed `Libplanet.Store.Store.GetCanonicalGenesisBlock<T>()` interface method and all its
...
### Deprecated APIs
 ...
 -  Removed `BlockChain<T>.MineBlock(PrivateKey, DateTimeOffset, bool, long,
    ...
    it `internal`.  [[#2529]]
 -  Removed `Libplanet.Store.Store.SetBlockPerceivedTime()` and
    `Libplanet.Store.Store.GetBlockPerceivedTime()` methods.  [[#2575]]
...
### Backward-incompatible API changes
 ...
 -  Removed unused transaction related methods from `Libplanet.Store.Store` and its
...
### Backward-incompatible API changes
 ...
 -  Added `Libplanet.Store.Store.GetCanonicalGenesisBlock(HashAlgorithmGetter)` method.
    [[#2162], [#2171]]
 ...
 -  Parameter `HashAlgorithmGetter hashAlgorithmGetter` removed from
    `Libplanet.Store.Store<T>.GetCanonicalGenesisBlock<T>()` and
    `Libplanet.Store.Store<T>.GetBlock<T>()` interface methods and their implementations.
    [[#2206], [#2207]]
 -  Parameter `HashAlgorithmGetter hashAlgorithmGetter` removed from
...
### Behavioral changes
 ...
 -  Nonexistent chain ids in `Libplanet.Store.Store` are now considered to be chain ids of
...
### Backward-incompatible API changes
 ...
 -  Added `Libplanet.Store.Store.PruneOutdatedChains(bool noopWithoutCanon)` method.
    [[#1874], [#1878]]
...
### Backward-incompatible API changes
 ...
 -  Removed `Libplanet.Store.Store.StageTransactionIds()` method.  [[#1166], [#1535]]
 -  Removed `Libplanet.Store.Store.UnstageTransactionIds()` method.  [[#1166], [#1535]]
 -  Removed `Libplanet.Store.Store.IterateStagedTransactionIds()` method.  [[#1166], [#1535]]
...
### Behavioral changes
 ...
 -  `Libplanet.Store.Store.ForkTxNonces()` method became to throw `ChainIdNotFoundException`
...
### Bug fixes
 ...
 -  Fixed `DefaultStore.ForkBlockIndexes()` method's bug that it had done
    ...
    been compliant with `Libplanet.Store.Store.ForkBlockIndexes()` method's specification.
    [[#1544]]
 ...
 -  (Libplanet.RocksDBStore) Fixed `RocksDBStore.ForkBlockIndexes()` method's
    ...
    existed, which had not been compliant with `Libplanet.Store.Store.ForkBlockIndexes()`
 ...
 -  (Libplanet.RocksDBStore) Fixed `MonoRocksDBStore.ForkBlockIndexes()`
    ...
    `Libplanet.Store.Store.ForkBlockIndexes()` method's specification.  [[#1544]]
 ...
 -  `Block<T>` and `BlockHeader` became aware of `HashAlgorithmType` used for
    proof-of-work mining.  [[#1492]]
     ...
     -  Added `HashAlgorithmGetter hashAlgorithmGetter` parameter to
        `Libplanet.Store.Store.GetBlock<T>()` method.
...
### Backward-incompatible API changes
 ...
 -  `Libplanet.Store.Store`, `TrieStateStore`, and `IKeyValueStore` interfaces now inherit
...
### Backward-incompatible API changes
 ...
 -  Block hashes are now represented as `BlockHash`, which was introduced in
    ...
    [[#1192], [#1197]]
     ...
     -  The type of `InvalidTxGenesisHashException.ImproperGenesisHash` property
        became `BlockHash?` (was `HashDigest<SHA256>?`).
     -  The return type of `Libplanet.Store.Store.IndexBlockHash()` method became `BlockHash?`
        (was `HashDigest<SHA256>?`).
     -  The type of `Libplanet.Store.Store.AppendIndex()` method's `hash` parameter became
        `BlockHash` (was `HashDigest<SHA256>`).
     -  Replaced `Libplanet.Store.Store.ForkBlockIndexes()` method's
        `HashDigest<SHA256> branchPoint` parameter with `BlockHash branchpoint`.
     -  The return type of `Libplanet.Store.Store.IterateIndexes()` method became
        `IEnumerable<BlockHash>` (was `IEnumerable<HashDigest<SHA256>>`).
     -  The return type of `Libplanet.Store.Store.IterateBlockHashes()` method became
        `IEnumerable<BlockHash>` (was `IEnumerable<HashDigest<SHA256>>`).
     -  The type of `Libplanet.Store.Store.GetBlock<T>()` method's `blockHash` parameter
        became `BlockHash` (was `HashDigest<SHA256>`).
     -  The type of `Libplanet.Store.Store.GetBlockIndex()` method's `blockHash` parameter
        became `BlockHash` (was `HashDigest<SHA256>`).
     -  The type of `Libplanet.Store.Store.GetBlockDigest()` method's `blockHash` parameter
        became `BlockHash` (was `HashDigest<SHA256>`).
     -  The type of `Libplanet.Store.Store.DeleteBlock()` method's `blockHash` parameter
        became `BlockHash` (was `HashDigest<SHA256>`).
     -  The type of `Libplanet.Store.Store.ContainsBlock()` method's `blockHash` parameter
        became `BlockHash` (was `HashDigest<SHA256>`).
 ...
 -  Added `Libplanet.Store.Store.PutTxExecution(TxSuccess)` method.  [[#1156], [#1289]]
 -  Added `Libplanet.Store.Store.PutTxExecution(TxFailure)` method.  [[#1156], [#1289]]
 -  Added `Libplanet.Store.Store.GetTxExecution()` method.  [[#1156], [#1289]]
 ...
 -  Added `Libplanet.Store.Store.BlockHashByTxId.Add(TxId, BlockHash)` method.
    [[#1294], [#1328]]
 -  Added `Libplanet.Store.Store.BlockHashByTxId[TxId]` method.
    [[#1294], [#1328]]
 -  Added `Libplanet.Store.Store.BlockHashByTxId.Remove(TxId, BlockHash)` method.
    [[#1294], [#1328]]
 -  Added `Libplanet.Store.Store.IterateTxIdBlockHashIndex(TxId)` method.  [[#1294], [#1328]]
...
### Backward-incompatible API changes
 ...
 -  Added `reorgResistantHeight` parameter into `DelayedActionRenderer<T>()`
    constructor.  [[#1163]]
 -  Added `Libplanet.Store.Store.SetBlockPerceivedTime()` method.  [[#1184]]
 -  Added `Libplanet.Store.Store.GetBlockPerceivedTime()` method.  [[#1184]]
 ...
 -  Added `Libplanet.Store.Store.ForkTxNonces()` method.  [[#1198]]
...
### Backward-incompatible API changes
 ...
 -  Extracted `Libplanet.Store.Store`'s some methods dedicated to block states into
 ...
 -  The signature of `Libplanet.Store.Store.LookupStateReference<T>(Guid, string, Block<T>)`
...
### Backward-incompatible API changes
 ...
 -  Removed `Libplanet.Store.Store.DeleteIndex(Guid, HashDigest<SHA256>)` method.  [[#802]]
...
### Added APIs
 ...
 -  Added `Libplanet.Store.Store.GetBlockDigest(HashDigest<SHA256>)` method.  [[#785]]
 -  Added `Block<T>.ToBlockDigest()` method.  [[#785]]
 -  Added `ByteArrayExtensions` class.  [[#803]]
 -  Added `Libplanet.Store.Store.PruneBlockStates<T>(Guid, Block<T>)` method.  [[#790]]
...
### Backward-incompatible API changes
 ...
 -  The internal representation for state keys became `string` (was `Address`).
    [[#368], [#774]]
     -  The return type of `Libplanet.Store.Store.GetBlockStates()` method became
        `IImmutableDictionary<string, IValue>` (was `AddressStateMap`,
        which was removed too).  [[#368], [#774]]
     -  The type of the second parameter of `Libplanet.Store.Store.SetBlockStates()` method
        became `IImmutableDictionary<string, IValue>` (was `AddressStateMap`,
        which was removed too).  [[#368], [#774]]
     -  The second parameter of `Libplanet.Store.Store.IterateStateReferences()` method became
        `string key` (was `Address address`).  [[#368], [#774]]
     -  The second parameter of `Libplanet.Store.Store.StoreStateReference()` method became
        `IImmutableSet<string> keys` (was `IImmutableSet<Address> addresses`).
        [[#368], [#774]]
     -  `Libplanet.Store.Store.ListAddresses()` method was replaced by `Libplanet.Store.Store.ListStateKeys()`
        method.  [[#368], [#774]]
 ...
 -  Removed `BlockChain<T>.Contains(TxId)` method.
    Use `Libplanet.Store.Store.ContainsTransaction(TxId)` instead.  [[#676]]
 ...
 -  Added `Libplanet.Store.Store.ContainsBlock(HashDigest<SHA256>)` method.  [[#678]]
 -  Removed `AddressStateMap` class.  [[#98], [#368], [#692], [#774]]
     -  The return type of `BlockChain<T>.GetState()` method became `IValue`
        (was `AddressStateMap`).
     -  The return type of `Libplanet.Store.Store.GetBlockStates()` method became
        `IImmutableDictionary<string, IValue>` (was `AddressStateMap`).
     -  `Libplanet.Store.Store.SetBlockStates()` method became to take
 ...
 -  `StoreExtension.LookupStateReference<T>()` method was replaced by
    `Libplanet.Store.Store.LookupStateReference<T>()` method.  [[#722], [#774]]
...
### Added APIs
 ...
 -  Added `Libplanet.Store.Store.ListAllStateReferences<T>()` method.  [[#701], [#703]]
 -  Added `Libplanet.Store.Store.ListStateKeys()` method to replace `Libplanet.Store.Store.ListAddresses()`
    method.  [[#368], [#774]]
 -  Added `Libplanet.Store.Store.LookupStateReference<T>()` method to replace
 ...
 -  Added `StoreExtension.Copy(this Libplanet.Store.Store, Libplanet.Store.Store)` extension method.  [[#753]]
...
### Backward-incompatible interface changes
 ...
 -  Renamed `Libplanet.Store.Store.IterateIndex()` method to `IterateIndexes()`.
    [[#462], [#560]]
 -  `Swarm<T>` class became to implement `IDisposable` again and should be
    disposed to clean up its internal resources.  [[#485]]
 -  `Libplanet.Store.Store.IterateStateReferences()` method became to receive
...
### Behavioral changes
 ...
 -  `Libplanet.Store.Store.PutBlock<T>()` became to do nothing when it takes
...
### Backward-incompatible interface changes
 ...
 -  The concept of "namespaces" in `Libplanet.Store.Store` was replaced by "chain IDs"
    to be consistent with `BlockChain<T>`.  [[#483], [#486]]
     -  Renamed `Libplanet.Store.Store.ListNamespaces()` method to `ListChainIds()`.
     -  Renamed `Libplanet.Store.Store.DeleteNamespace()` method to `DeleteChainId()`.
     -  Renamed `Libplanet.Store.Store.GetCanonicalNamespace()` method to
        `GetCanonicalChainId()`.
     -  Renamed `Libplanet.Store.Store.SetCanonicalNamespace(string)` method to
        `SetCanonicalChainId(Guid)`.
     -  Replaced `namespace`/`sourceNamespace`/`destinationNamespace` parameters
        taking `string` of methods in `Libplanet.Store.Store` and `StoreExtension` with
 ...
 -  `Libplanet.Store.Store.StoreStateReference<T>(string, IImmutableSet<Address>, Block<T>)`
 ...
 -  Added `Libplanet.Store.Store.ForkBlockIndexes()` method.  [[#420]]
 -  Removed `addressesToStrip` parameter from `Libplanet.Store.Store.ForkStateReferences<T>()`
 ...
 -  Removed the concept of "staged transactions that should not be broadcasted,"
    ...
    All staged transactions became broadcasted.  [[#319], [#470]]
     ...
     -  Removed `toBroadcast` parameter from
        `Libplanet.Store.Store.IterateStagedTransactionIds(bool)` method.
     -  `Libplanet.Store.Store.StageTransactionIds(IDictionary<TxId, bool>)` method became
...
### Bug fixes
 ...
 -  Fixed a bug that `Swarm<T>.PreloadAsync()` method had thrown `LiteException`
    (or other exception depending on `Libplanet.Store.Store`), which indicates a state
 ...
 -  Fixed a bug tag `Swarm<T>.StartAsync()` sometimes had thrown an exception
    from `Libplanet.Store.Store` (e.g., `NullReferenceException`) during broadcasting
...
### Backward-incompatible interface changes
 ...
 -  Added `Libplanet.Store.Store.GetBlockIndex()` method.  [[#385]]
 ...
 -  `BlockDownloadState.TotalBlockCount` and
    ...
    [[#396], [#399]]
 -  `Libplanet.Store.Store.IterateIndex()` method became to receive `offset` and `limit`
    parameters.  [[#425]]
 -  Added `Libplanet.Store.Store.GetCanonicalNamespace()` method.  [[#426]]
 -  Added `Libplanet.Store.Store.SetCanonicalNamespace()` method.  [[#426]]
...
### Added interfaces
 ...
 -  Added `trustedStateValidators` option to `Swarm<T>.PreloadAsync()` method.
    ...
    for themselves.
    [[#272], [#343]]
 -  Added `StoreExtension.ListAllStateReferences(this Libplanet.Store.Store, string,
...
### Behavioral changes
 ...
 -  `FileStore` and `LiteDBStore` became to guarantee atomicity of storing
    transactions.  [[#413]]
 -  `Libplanet.Store.Store.PutTransaction<T>()` became to do nothing when it takes
...
### Backward-incompatible interface changes
 ...
 -  `Peer.AppProtocolVersion` became nullable to represent `Peer` whose version
    is unknown.  [[#280]]
 -  Added `Libplanet.Store.Store.ListAddresses()` method.  [[#272], [#285]]
 -  Added `Libplanet.Store.Store.ListTxNonces()` method.  [[#272], [#309], [#310]]
 ...
 -  `BlockChain<T>.StageTransactions` became to receive
    ...
    [[#274], [#297]]
 -  `Libplanet.Store.Store.StageTransactionIds()` method became to receive
    `IDictionary<TxId, bool>` instead of `ISet<TxId>`.  [[#274], [#297]]
 -  `Libplanet.Store.Store.IterateStagedTransactionIds()` method became to receive
 ...
 -  `Libplanet.Store.Store` became to treat a "tx nonce" mere a `long` integer instead of
    a stack of block hashes.  [[#272], [#307], [#309], [#310]]
     -  `Libplanet.Store.Store.IncreaseTxNonce<T>(string, Block<T>)` method was replaced by
        `Libplanet.Store.Store.IncreaseTxNonce(string, Address, long)` method.
     -  Removed `Libplanet.Store.Store.ForkTxNonce()` method.
     -  `FileStore` became to occupy fewer bytes for storing tx nonces.
        This change broke file-level backward compatibility.
 -  `Libplanet.Store.Store` became possible to look up multiple state references in a stack.
    [[#272], [#307]]
     -  Removed `Libplanet.Store.Store.LookupStateReference<T>()` method.
        Instead, a newly added static class `StoreExtension` provides
        an extension method of the same name.
     -  Added `Libplanet.Store.Store.IterateStateReferences()` method.
 ...
 -  Added `Libplanet.Store.Store.DeleteNamespace()` method.  [[#329]]
...
### Behavioral changes
 ...
 -  `Libplanet.Store.Store.GetBlockStates()` became able to return `null` to represent
...
### Backward-incompatible interface changes
 ...
 -  The signature of `Libplanet.Store.Store.PutBlock<T>(Block<T>)` method was changed to
 ...
 -  `Block<T>.Hash` is no longer calculated using the full data of the
    ...
    [[#234]]
 -  Added `Libplanet.Store.Store.LookupStateReference<T>(string, Address, Block<T>)` method.
    [[#232]]
 -  Added `Libplanet.Store.Store.StoreStateReference<T>(string, Block<T>)` method.
    [[#232]]
 -  Added `Libplanet.Store.Store.ForkStateReferences<T>(string, string, Block<T>,
 ...
 -  Added `Transaction<T>.Nonce` and `RawTransaction.Nonce` properties.
    [[#246]]
 -  Added `Libplanet.Store.Store.GetTxNonce(string, Address)` method.  [[#246]]
 -  Added `Libplanet.Store.Store.IncreaseTxNonce<T>(string, Block<T>)` method.  [[#246]]
 -  Added `Libplanet.Store.Store.ForkTxNonce<T>(string, string, Block<T>,
...
Released on April 5, 2019.
 ...
 -  Removed `AddressTransactionSet` which handles handle `Address` to
    `IEnumerable<TxId>` indices, and the following methods in `Libplanet.Store.Store`:
     -  `Libplanet.Store.Store.IterateAddresses()`
     -  `Libplanet.Store.Store.GetAddressTransactionIds()`
     -  `Libplanet.Store.Store.AppendAddressTransactionId()`
     -  `Libplanet.Store.Store.CountAddresses()`
 -  Added `Libplanet.Store.Store.ListNamespaces()` method.
 -  `Libplanet.Store.Store.CountBlocks()` and `Libplanet.Store.Store.CountTransactions()` became to return
    `long`.
 -  Block/tx-related methods in `Libplanet.Store.Store` and `BaseIndex<T>` no longer
