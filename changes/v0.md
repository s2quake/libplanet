...
### Backward-incompatible API changes
 ...
 -  Added `Libplanet.Store.Store.PutTxIdBlockHashIndex(TxId, BlockHash)` method.
    [[#1294], [#1328]]
 -  Added `Libplanet.Store.Store.GetFirstTxIdBlockHashIndex(TxId)` method.
    [[#1294], [#1328]]
 -  Added `Libplanet.Store.Store.DeleteTxIdBlockHashIndex(TxId, BlockHash)` method.
    [[#1294], [#1328]]
