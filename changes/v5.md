...
### Bug fixes
 ...
 -  Fixed a bug in `Libplanet.Store.Store.PruneOutdatedChains()`.  [[#3999]]
...
### Backward-incompatible API changes
 ...
 -  (Libplanet.Net) Changed `ActionExecutionState` and `BlockVerificationState`
    to be `Obsolete`.  [[#3943]]
 -  (Libplanet.Action) Export `PolicyActions` interface
...
### Added APIs
 ...
 -  (Libplanet.Action) Added `PolicyActions` class.  [[#3748]]
...
### Added APIs
 ...
 -  (Libplanet.Store) Added `Libplanet.Store.Store.IteratePendingEvidenceIds`. method.
    [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.GetPendingEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.GetCommittedEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.PutPendingEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.PutCommittedEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.DeletePendingEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.DeleteCommittedEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.ContainsPendingEvidence`. method.  [[#3696]]
 -  (Libplanet.Store) Added `Libplanet.Store.Store.ContainsCommittedEvidence`. method.
    [[#3696]]
