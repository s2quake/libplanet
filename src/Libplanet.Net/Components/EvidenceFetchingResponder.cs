...
public sealed class EvidenceFetchingResponder(Blockchain blockchain, ITransport transport, int maxAccessCount)
    : IDisposable
{
    ...
    public EvidenceFetchingResponder(Blockchain blockchain, ITransport transport)
