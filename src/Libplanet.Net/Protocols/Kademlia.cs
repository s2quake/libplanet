...
//     public Kademlia(RoutingTable routingTable, ITransport transport)
//     {
...
//     //     foreach (Peer peer in _table.GetNeighbors(target, _findConcurrency))
//     //     {
...
//     //     _table.AddOrUpdate(peer, updated);

//     //     if (!_table.AddOrUpdate(peer, updated) && !_pool.AddOrUpdate(peer, updated))
//     //     {
...
//     // {
//     //     var neighbors = _table.GetNeighbors(target, _table.Buckets.Count);
...
//     //     var closestCandidate = _table.GetNeighbors(target, _table.Buckets.Count);
