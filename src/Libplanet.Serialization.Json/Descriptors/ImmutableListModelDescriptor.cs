...
// internal sealed class ImmutableListModelDescriptor : ModelDescriptor
// {
//     public override bool CanSerialize(Type type) => IsImmutableList(type);
...
//             typeof(ImmutableList), methodName, typeof(IEnumerable<>));
...
//             var value1 = items1[i];
//             var value2 = items2[i];
//             if (!ModelResolver.Equals(value1, value2, elementType))
//             {
//                 return false;
//             }
//         }
...
//     private static bool IsImmutableList(Type type)
//     {
...
//         throw new UnreachableException("The type is not an ImmutableList.");
//     }
