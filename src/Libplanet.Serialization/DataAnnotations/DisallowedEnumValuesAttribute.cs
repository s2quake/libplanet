...
public sealed class DisallowedEnumValuesAttribute(params object[] enumValues) : ValidationAttribute
{
    ...
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
    {
        ...
        if (EnumValues.Contains(value))
        {
            return new ValidationResult(
                $"The value '{value}' cannot be used. It is one of the disallowed enum values: " +
