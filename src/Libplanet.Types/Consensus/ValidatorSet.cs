...
//     /// </summary>
//     public class ImmutableSortedSet<Validator> : IEquatable<ImmutableSortedSet<Validator>>, IBencodable
//     {
//         /// <summary>
//         /// Creates an instance of an empty <see cref="ImmutableSortedSet<Validator>"/>.
//         /// to <see cref="Validators"/>.
//         /// </summary>
//         public ImmutableSortedSet<Validator>()
//             : this(new List<Validator>())
//         {
//         }

//         /// <summary>
//         /// Creates an instance of <see cref="ImmutableSortedSet<Validator>"/>.  Given <paramref name="validators"/>
...
//         /// </list>
//         /// </exception>
//         public ImmutableSortedSet<Validator>(List<Validator> validators)
//         {
//             if (validators
...
//         public ImmutableSortedSet<Validator>(Bencodex.Types.IValue bencoded)
...
//         private ImmutableSortedSet<Validator>(Bencodex.Types.List bencoded)
...
//         /// <summary>
//         /// Checks if given <paramref name="validator"/> is a member of <see cref="ImmutableSortedSet<Validator>"/>.
...
//         /// <summary>
//         /// Checks if given <paramref name="publicKey"/> is a member of <see cref="ImmutableSortedSet<Validator>"/>.
//         /// </summary>
...
//         /// <summary>
//         /// Creates a new <see cref="ImmutableSortedSet<Validator>"/> that has been updated with
...
//         /// <returns>New <see cref="ImmutableSortedSet<Validator>"/> updated with
//         /// given <paramref name="validator"/>.</returns>
//         [Pure]
//         public ImmutableSortedSet<Validator> Update(Validator validator)
//         {
...
//             {
//                 return new ImmutableSortedSet<Validator>(updated);
//             }
//             else
//             {
...
//         public bool Equals(ImmutableSortedSet<Validator>? other) =>
//         other is ImmutableSortedSet<Validator> validators && Validators.SequenceEqual(validators.Validators);

//         public override bool Equals(object? obj) => obj is ImmutableSortedSet<Validator> other && Equals(other);
