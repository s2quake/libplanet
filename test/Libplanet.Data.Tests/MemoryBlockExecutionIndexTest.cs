...
public sealed class MemoryBlockExecutionIndexTest(ITestOutputHelper output)
    : MemoryKeyedIndexTestBase<BlockHash, BlockExecutionResult, BlockExecutionIndex>(output)
{
    ...
    protected override BlockExecutionResult CreateValue(Random random) => RandomUtility.BlockExecution(random);
}
