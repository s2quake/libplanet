...
[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction0")]
public sealed record class SimpleAction0 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction1")]
public sealed record class SimpleAction1 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction2")]
public sealed record class SimpleAction2 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction3")]
public sealed record class SimpleAction3 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction4")]
public sealed record class SimpleAction4 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction5")]
public sealed record class SimpleAction5 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction6")]
public sealed record class SimpleAction6 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction7")]
public sealed record class SimpleAction7 : SimpleAction
{
}

[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction8")]
public sealed record class SimpleAction8 : SimpleAction
{
}

// For overlapping custom action id test and fail test
[Model(Version = 1, TypeName = "Libplanet_Explorer_Tests_SimpleAction0Fail")]
