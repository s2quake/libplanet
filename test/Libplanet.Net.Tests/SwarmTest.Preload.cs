...
public partial class SwarmTest
{
    ...
    //     await using var minerSwarm = await CreateSwarm(minerKey);
    //     await using var receiverSwarm = await CreateSwarm();
    ...
    // {
    //     Swarm minerSwarm = await CreateSwarm();
    ...
    //         await receiverSwarm.AddPeersAsync(new[] { minerSwarm.Peer }, null);
    ...
    //     {
    //         var block = chainB.ProposeBlock(new PrivateKey());
    //         chainB.Append(block, TestUtils.CreateBlockCommit(block));
    //         chainC.Append(block, TestUtils.CreateBlockCommit(block));
    //     }

    //     var specialBlock = chainB.ProposeBlock(new PrivateKey());
    ...
    //     {
    //         var block = chainC.ProposeBlock(new PrivateKey());
    //         chainC.Append(block, TestUtils.CreateBlockCommit(block));
    //     }
    ...
    //         await swarmA.AddPeersAsync(new[] { swarmB.Peer }, null);
    //         await swarmB.AddPeersAsync(new[] { swarmA.Peer }, null);
    ...
    //         await swarmA.AddPeersAsync(new[] { swarmC.Peer }, null);
    //         await swarmC.AddPeersAsync(new[] { swarmA.Peer }, null);
    ...
    //     await BootstrapAsync(receiver, sender.Peer);
    ...
    //     var nominerSwarm1 =
    //         await CreateSwarm(blockChainsForNominers[1]);
    ...
    //     {
    //         Block block = minerChain.ProposeBlock(minerKey);
    ...
    //         await nominerSwarm0.AddPeersAsync(new[] { minerSwarm.Peer }, null);
    //         await nominerSwarm0.PreloadAsync(TimeSpan.FromSeconds(1), 0);
    //         await nominerSwarm1.AddPeersAsync(new[] { nominerSwarm0.Peer }, null);
    //         await nominerSwarm1.PreloadAsync(TimeSpan.FromSeconds(1), 0);
    //         await receiverSwarm.AddPeersAsync(new[] { nominerSwarm1.Peer }, null);
    ...
    //     Swarm swarm0 = await CreateSwarm(key0);
    ...
    //     await receiverSwarm.AddPeersAsync(new[] { swarm0.Peer, swarm1.Peer }, null);
    //     Assert.Equal(
    //         new[] { swarm0.Peer, swarm1.Peer }.ToImmutableHashSet(),
    //         receiverSwarm.Peers.ToImmutableHashSet());

    //     var startedStop = false;
    //     var shouldStopSwarm =
    //         swarm0.Peer.Equals(receiverSwarm.Peers.First()) ? swarm0 : swarm1;
    ...
    //     Assert.InRange(receiverChain.Blocks.Count, 0, 1);
    ...
    //     {
    //         (minerSwarm.Peer, minerChain.Tip),
    //     };
    ...
    //             new[] { minerSwarm1.Peer, minerSwarm2.Peer },
    //             null);
    ...
    //         await CreateSwarm(validSeedChain);
    //     Swarm invalidSeedSwarm =
    //         await CreateSwarm(invalidSeedChain);
    ...
    //     for (int i = 0; i < 10; i++)
    //     {
    //         Block block = validSeedChain.ProposeBlock(key1);
    //         validSeedChain.Append(block, CreateBlockCommit(block));
    //     }

    //     for (int i = 0; i < 20; i++)
    //     {
    //         Block block = invalidSeedChain.ProposeBlock(key1);
    ...
    //         await receiverSwarm.AddPeersAsync(
    //             new[] { validSeedSwarm.Peer, invalidSeedSwarm.Peer }, null);
    //         await receiverSwarm.PreloadAsync();
