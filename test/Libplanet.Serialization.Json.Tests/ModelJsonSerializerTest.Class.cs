...
public sealed partial class ModelJsonSerializerTest
{
    [Fact]
    public void ObjectClass_SerializeAndDeserialize_Test()
    {
        var expectedObject = new ObjectClass();
        var serialized = ModelJsonSerializer.SerializeToString(expectedObject);
        var actualObject = ModelJsonSerializer.DeserializeFromString<ObjectClass>(serialized)!;
    ...
    public void ArrayClass_SerializeAndDeserialize_Test()
    {
        ...
        var serialized = ModelJsonSerializer.SerializeToString(expectedObject);
        var actualObject = ModelJsonSerializer.DeserializeFromString<ArrayClass>(serialized)!;
        Assert.Equal(expectedObject, actualObject);
    }
    ...
    public void MixedClass_SerializeAndDeserialize_Test()
    {
        ...
        var serialized = ModelJsonSerializer.SerializeToString(expectedObject);
        var actualObject = ModelJsonSerializer.DeserializeFromString<MixedClass>(serialized)!;
        Assert.Equal(expectedObject, actualObject);
    }
    ...
    [Model(Version = 1, TypeName = "Libplanet_Serialization_Tests_ModelJsonSerializerTest_ObjectClass")]
    ...
    [Model(Version = 1, TypeName = "Libplanet_Serialization_Tests_ModelJsonSerializerTest_ArrayClass")]
    ...
    [Model(Version = 1, TypeName = "Libplanet_Serialization_Tests_ModelJsonSerializerTest_MixedClass")]
