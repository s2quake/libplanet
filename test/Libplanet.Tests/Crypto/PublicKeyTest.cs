...
public class PublicKeyTest(ITestOutputHelper output)
{
    [Fact]
    public void Constructor()
    {
        ...
        var compressedMutable = new PublicKey(mutable.ToByteArray(compress: true));
    ...
    public void FromHex()
    {
        var expected = new PublicKey(ImmutableArray.Create<byte>([
    ...
    public void ToHex()
    {
        var key1 = new PublicKey(ImmutableArray.Create<byte>([
            0x04, 0x46, 0x11, 0x5b, 0x01, 0x31, 0xba, 0xcc, 0xf9, 0x4a,
            0x58, 0x56, 0xed, 0xe8, 0x71, 0x29, 0x5f, 0x6f, 0x3d, 0x35,
            0x2e, 0x68, 0x47, 0xcd, 0xa9, 0xc0, 0x3e, 0x89, 0xfe, 0x09,
            0xf7, 0x32, 0x80, 0x87, 0x11, 0xec, 0x97, 0xaf, 0x6e, 0x34,
