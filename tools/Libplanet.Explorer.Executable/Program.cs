...
namespace Libplanet.Explorer.Executable
{
    ...
    public class Program : CoconaLiteConsoleAppBase
    {
        ...
        public void Schema()
        {
            ...
            serviceCollection.AddSingleton<Libplanet.Data.Repository, Libplanet.Data.Repository>();
...
If omitted (default) explorer only the local blockchain store.")]
            string[] seedStrings = null)
        {
            ...
            try
            {
                ...
                StateIndex stateStore = new NoOpStateStore();
        ...
        private static Libplanet.Data.Repository LoadStore(Options options)
        {
            ...
            {
                case "rocksdb":
                    return new Repository(new RocksDatabase(
                      options.StorePath,
        ...
        private static BlockchainOptions LoadBlockPolicy(Options options)
        {
            ...
            {
                SystemAction = SystemAction.Empty,
