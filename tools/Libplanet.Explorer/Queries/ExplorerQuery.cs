...
namespace Libplanet.Explorer.Queries
{
    public class ExplorerQuery : ObjectGraphType
    {
            ...
            Address? signer, bool desc, int offset, int? limit)
        {
            ...
            var stagedTxs = Chain.StagedTransactions.Values
            ...
            bool desc, int offset, int? limit)
        {
            ...
            var evidence = blockChain.PendingEvidence.Values
                                      .Skip(offset)
        ...
        internal static EvidenceBase GetEvidence(EvidenceId id) => Chain.Evidence[id];
